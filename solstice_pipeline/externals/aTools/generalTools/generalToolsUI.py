...
from solstice_pipeline.externals.aTools.generalTools.aToolsGlobals import aToolsGlobals as G
from solstice_pipeline.externals.aTools.commonMods      import uiMod
from solstice_pipeline.externals.aTools.commonMods      import utilMod
from solstice_pipeline.externals.aTools.commonMods      import animMod
from solstice_pipeline.externals.aTools.commonMods      import commandsMod
from solstice_pipeline.externals.aTools.commonMods      import aToolsMod
from solstice_pipeline.externals.aTools                 import setup
from solstice_pipeline.externals.aTools.generalTools    import hotkeys;                     reload(hotkeys)
from solstice_pipeline.externals.aTools.generalTools    import tumbleOnObjects;             reload(tumbleOnObjects)
from solstice_pipeline.externals.aTools.animTools       import animationCrashRecovery;      reload(animationCrashRecovery)
from solstice_pipeline.externals.aTools.animTools       import framePlaybackRange;          reload(framePlaybackRange)
from solstice_pipeline.externals.aTools.animTools       import jumpToSelectedKey;           reload(jumpToSelectedKey)
...
class GeneralTools_Gui(uiMod.BaseSubUI):
    ...
    def uninstall(self, *args):
        ...
        if confirm == 'Yes':      
            ...
            from solstice_pipeline.externals.aTools.animTools.animBar import animBarUI; reload(animBarUI)
...
def shelfButton(*args):
    ...
    command         = "from solstice_pipeline.externals.aTools.animTools.animBar import animBarUI; animBarUI.show('toggle')"
