...
from solstice_pipeline.externals.aTools.commonMods import uiMod;   reload(uiMod)
...
for loopMod in MODULES:
    exec("from solstice_pipeline.externals.aTools.animTools.animBar.subUIs.specialTools_subUIs import %s; reload(%s)"%(loopMod, loopMod))
