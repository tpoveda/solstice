...
class LibraryItem(solstice_studioqt.CombinedWidgetItem):
    ...
    ThumbnailPath = solstice_studioqt.resource.get("icons", "thumbnail.png")
    ...
    def __init__(
        ...
        :type path: str
        :type database: solstice_studiolibrary.Database or None 
        :type libraryWidget: solstice_studiolibrary.LibraryWidget or None
        """
        solstice_studioqt.CombinedWidgetItem.__init__(self)
    ...
    def showErrorDialog(self, title, text):
        ...
        return solstice_studioqt.MessageBox.critical(self.libraryWidget(), title, text)
    ...
    def showQuestionDialog(self, title, text):
        ...
        :rtype: QMessageBox.StandardButton
        """
        return solstice_studioqt.MessageBox.question(self.libraryWidget(), title, text)
    ...
    def showInFolder(self):
        ...
        path = self.path()
        solstice_studiolibrary.showInFolder(path)
    ...
    def libraryWidget(self):
        """
        :rtype: solstice_studiolibrary.LibraryWidget or None
        """
    ...
    def database(self):
        ...
        :rtype: solstice_studiolibrary.Database or None
        """
    ...
    def updateData(self):
        ...
        dirname, basename, extension = solstice_studiolibrary.splitPath(path)
        ...
        if os.path.exists(path):
            ...
            timeAgo = solstice_studiolibrary.timeAgo(modified)
    ...
    def save(self, path=None, contents=None):
        ...
        solstice_studiolibrary.movePaths(contents, path)
    ...
    def delete(self):
        ...
        solstice_studiolibrary.removePath(path)
    ...
    def copy(self, dst):
        ...
        path = solstice_studiolibrary.copyPath(src, dst)
        self.setPath(path)
    ...
    def move(self, dst):
        ...
        dst = solstice_studiolibrary.movePath(src, dst)
        self.setPath(dst)
    ...
    def rename(self, dst, extension=None, force=True):
        ...
        dst = solstice_studiolibrary.renamePath(src, dst)
        self.setPath(dst)
    ...
    def showRenameDialog(self, parent=None):
        ...
        name, button = solstice_studioqt.MessageBox.input(
            parent,
            "Rename item",
    ...
    def showAlreadyExistsDialog(self):
        ...
        if button == QtWidgets.QMessageBox.Yes:
            item = solstice_studiolibrary.LibraryItem(path)
    ...
    def paint(self, painter, option, index):
        ...
        :rtype: None
        """
        solstice_studioqt.CombinedWidgetItem.paint(self, painter, option, index)
