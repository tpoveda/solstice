...
class Database(QtCore.QObject):
    ...
    def startWatcher(self, repeatRate=None):
        ...
        self._watcher = solstice_studioqt.InvokeRepeatingThread(repeatRate)
    ...
    def normPath(self, path):
        ...
        :rtype: str
        """
        return solstice_studiolibrary.normPath(path)
    ...
    def read(self):
        ...
        :rtype: dict
        """
        return solstice_studiolibrary.readJson(self.path())
    ...
    def save(self, data):
        ...
        :rtype: None
        """
        solstice_studiolibrary.saveJson(self.path(), data)
    ...
    def update(self, data):
        ...
        :rtype: dict
        """
        return solstice_studiolibrary.updateJson(self.path(), data)
    ...
    def replace(self, old, new, count=-1):
        ...
        :rtype: dict
        """
        return solstice_studiolibrary.replaceJson(self.path(), old, new, count)
