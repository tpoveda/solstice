...
class CombinedWidget(QtWidgets.QWidget):
    ...
    def __init__(self, *args):
        ...
        self._toastWidget = solstice_studioqt.ToastWidget(self)
    ...
    def _itemClicked(self, item):
        ...
        :type item: solstice_studioqt.CombinedWidgetItem
        :rtype: None
        """
        if isinstance(item, solstice_studioqt.CombinedWidgetItemGroup):
    ...
    def createItemSettingsMenu(self):
        ...
        action = solstice_studioqt.SeparatorAction("View Settings", menu)
        menu.addAction(action)

        action = solstice_studioqt.SliderAction("Size", menu)
        ...
        action = solstice_studioqt.SliderAction("Border", menu)
        ...
        menu.addAction(action)
        #
        action = solstice_studioqt.SliderAction("Spacing", menu)
        ...
        action = solstice_studioqt.SeparatorAction("Item Options", menu)
        menu.addAction(action)
