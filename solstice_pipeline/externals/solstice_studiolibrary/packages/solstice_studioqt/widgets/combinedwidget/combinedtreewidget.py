...
class CombinedTreeWidget(CombinedItemViewMixin, QtWidgets.QTreeWidget):
    ...
    def setItemsSelected(self, items, value, scrollTo=True):
        ...
        :type items: list[solstice_studioqt.CombinedWidget]
        :type value: bool
        :type scrollTo: bool
    ...
    def selectedItem(self):
        ...
        :rtype: solstice_studioqt.CombinedWidgetItem
        """
    ...
    def selectedItems(self):
        ...
        :rtype: list[solstice_studioqt.CombinedWidgetItem]
        """
        items = []
        items_ = QtWidgets.QTreeWidget.selectedItems(self)

        for item in items_:
            if not isinstance(item, solstice_studioqt.CombinedWidgetItemGroup):
                items.append(item)
    ...
    def itemRow(self, item):
        ...
        :type item: solstice_studioqt.TreeWidgetItem
        :rtype: int
        """
    ...
    def items(self):
        ...
        :rtype: lsit[solstice_studioqt.TreeWidgetItem]
        """
        items = []
    ...
    def moveItems(self, items, itemAt):
        ...
        :type items: list[solstice_studioqt.CombinedWidgetItem]
        :type itemAt: solstice_studioqt.CombinedWidgetItem
        :rtype: None
        """
        row = 0
        column = self.columnFromLabel("Custom Order")
    ...
    def createSortByMenu(self):
        ...
        action = solstice_studioqt.SeparatorAction("Sort By", menu)
        ...
        action = solstice_studioqt.SeparatorAction("Sort Order", menu)
        menu.addAction(action)
    ...
    def createGroupItem(self, text, children):
        ...
        :type text: str
        :type children: list[solstice_studioqt.CombinedWidgetItem]
        :rtype: solstice_studioqt.CombinedWidgetItemGroup
        """
        groupItem = solstice_studioqt.CombinedWidgetItemGroup()
    ...
    def itemsGroupByColumn(self, groupColumn, groupOrder, items=None):
        ...
        :type groupOrder int
        :type items: None or list[solstice_studioqt.CombinedWidgetItem]
        :rtype: dict
        """
    ...
    def createGroupByMenu(self):
        ...
        action = solstice_studioqt.SeparatorAction("Group By", menu)
        menu.addAction(action)
        ...
        action = solstice_studioqt.SeparatorAction("Group Order", menu)
        menu.addAction(action)
