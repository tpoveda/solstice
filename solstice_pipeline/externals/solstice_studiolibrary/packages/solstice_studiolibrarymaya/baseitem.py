...
class BaseItem(solstice_studiolibrary.LibraryItem):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :type kwargs: dict
        """
        solstice_studiolibrary.LibraryItem.__init__(self, *args, **kwargs)
    ...
    def setTransferClass(self, classname):
        ...
        :type classname: solstice_mutils.TransferObject
        """
    ...
    def transferClass(self):
        ...
        :rtype: solstice_mutils.TransferObject
        """
    ...
    def contextMenu(self, menu, items=None):
        ...
        solstice_studiolibrary.LibraryItem.contextMenu(self, menu, items=items)
    ...
    def selectContent(self, namespaces=None, **kwargs):
        ...
        kwargs = kwargs or solstice_mutils.selectionModifiers()
    ...
    def mirrorTable(self):
        ...
        :rtype: solstice_mutils.MirrorTable or None
        """
        mirrorTable = None
        ...
        if mirrorTablePath:
            ...
            if path:
                mirrorTable = solstice_mutils.MirrorTable.fromPath(path)
    ...
    def mirrorTablePaths(self):
        ...
        :rtype: list[str]
        """
        paths = list(solstice_studiolibrary.walkup(
                self.path(),
    ...
    def namespacesFromSelection():
        ...
        try:
            namespaces = solstice_mutils.namespace.getFromSelection() or namespaces
        except NameError, e:
