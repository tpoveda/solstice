...
class SetsItem(baseitem.BaseItem):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setTransferClass(solstice_mutils.SelectionSet)
...
iconPath = solstice_studiolibrarymaya.resource().get("icons", "selectionSet.png")
...
solstice_studiolibrary.registerItem(SetsItem)
