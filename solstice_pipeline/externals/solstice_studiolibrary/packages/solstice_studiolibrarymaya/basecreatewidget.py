...
class BaseCreateWidget(QtWidgets.QWidget):
    ...
    def __init__(self, item, parent=None):
        """
        :type item: solstice_studiolibrarymaya.BaseItem
        :type parent: QtWidgets.QWidget
        """
        QtWidgets.QWidget.__init__(self, parent)
        self.setObjectName("solstice_studiolibraryMayaCreateWidget")

        self.setWindowTitle("Create Item")

        solstice_studioqt.loadUi(self)
    ...
    def libraryWidget(self):
        ...
        :rtype: libraryWidget: solstice_studiolibrary.LibraryWidget
        """
    ...
    def item(self):
        ...
        :rtype: solstice_studiolibrarymaya.BaseItem
        """
        return self._item
    ...
    def settings(self):
        ...
        :rtype: solstice_studiolibrary.Settings
        """
        return solstice_studiolibrarymaya.settings()
    ...
    def saveSettings(self):
        ...
        """
        data = self.settings()
        solstice_studiolibrarymaya.saveSettings(data)
    ...
    def scriptJob(self):
        ...
        :rtype: solstice_mutils.ScriptJob
        """
    ...
    def setScriptJobEnabled(self, enable):
        ...
        if enable:
            if not self._scriptJob:
                ...
                self._scriptJob = solstice_mutils.ScriptJob(event=event)
        else:
            sj = self.scriptJob()
            if sj:
                sj.kill()
    ...
    def thumbnailCapture(self):
        ...
        :rtype: None
        """
        path = solstice_mutils.gui.tempThumbnailPath()
        solstice_mutils.gui.thumbnailCapture(path=path, captured=self._thumbnailCaptured)
    ...
    def setCaptureMenuEnabled(self, enable):
        ...
        if enable:
            parent = self.parent()
            iconPath = solstice_mutils.gui.tempThumbnailPath()

            menu = solstice_mutils.gui.ThumbnailCaptureMenu(
                iconPath,
                force=True,
                parent=parent
            )
    ...
    def accept(self):
        ...
        try:
            ...
            solstice_studioqt.MessageBox.critical(self.libraryWidget(), title, str(e))
            raise
