...
class FrameRangeMenu(QtWidgets.QMenu):
    ...
    def __init__(self, parent=None):
        ...
        action.setFrameRange(solstice_mutils.playbackFrameRange())
        self.addAction(action)

        action = FrameRangeAction("From Selected Timeline", self)
        action.setFrameRange(solstice_mutils.selectedFrameRange())
        self.addAction(action)

        action = FrameRangeAction("From Selected Objects", self)
        action.setFrameRange(solstice_mutils.selectedObjectsFrameRange())
        self.addAction(action)
