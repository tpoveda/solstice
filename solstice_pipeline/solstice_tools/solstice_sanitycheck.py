...
from solstice_pipeline.solstice_gui import solstice_windows, solstice_stack, solstice_spinner, solstice_splitters, solstice_assetviewer, solstice_console, solstice_asset
from solstice_pipeline.solstice_utils import solstice_image, solstice_qt_utils
...
class SanityCheckWaiting(QFrame, object):
    def __init__(self, parent=None):
        ...
        self.wait_spinner = solstice_spinner.WaitSpinner()
...
class SanityCheck(solstice_windows.Window, object):
    ...
    def custom_ui(self):
        ...
        self.asset_name = solstice_splitters.Splitter('')
        ...
        icon_layout.addItem(QSpacerItem(10, 0, QSizePolicy.Expanding, QSizePolicy.Preferred))
        check_asset_layout.addLayout(solstice_splitters.SplitterLayout())
    ...
    def show_check_menu(self, asset=None, *args, **kwargs):
        ...
        if isinstance(asset, solstice_asset.CharacterAsset):
        ...
        self.asset_icon.setPixmap(QPixmap.fromImage(solstice_image.base64_to_image(asset._icon, image_format=asset._icon_format)).scaled(200, 200, Qt.KeepAspectRatio))
    ...
    def _do_check(self, check_type):
        ...
        solstice_qt_utils.clear_layout_widgets(self.sanity_layout)
        self._log.clear()
