...
from solstice_pipeline.solstice_checks import solstice_validator, solstice_taskgroups
...
class ShadingValidator(solstice_validator.SanityCheckValidator, object):
    def __init__(self, asset):
        ...
        self._check = solstice_taskgroups.AssetPublishSantiyCheck(asset=self._asset, file_type='shading', auto_fix=True, stop_on_error=True)
