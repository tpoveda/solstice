...
from solstice_pipeline.solstice_pickers.picker import picker_buttons
...
class PickerPart(QObject, object):
    ...
    def get_ik_buttons(self):
        ...
        return [btn for btn in self._buttons if isinstance(btn, picker_buttons.IKButton)]
    ...
    def get_fk_buttons(self):
        ...
        return [btn for btn in self._buttons if isinstance(btn, picker_buttons.FKButton)]
