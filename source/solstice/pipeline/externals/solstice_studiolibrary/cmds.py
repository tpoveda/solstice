...
def registerItem(cls):
    ...
    :type cls: solstice_studiolibrary.LibraryItem
    :rtype: None
    """
    global _itemClasses
...
def itemFromPath(path, **kwargs):
    ...
    :type path: str
    :rtype: solstice_studiolibrary.LibraryItem or None
    """
    path = normPath(path)
...
def itemsFromPaths(paths, **kwargs):
    ...
    :type paths: list[str]:
    :rtype: collections.Iterable[solstice_studiolibrary.LibraryItem]
    """
    for path in paths:
...
def localPath(*args):
    ...
    path = os.path.join(path, "solstice_studiolibrary", *args)
...
def sendEvent(name, version="1.0.0", an="solstice_studiolibrary", tid=None):
    """
