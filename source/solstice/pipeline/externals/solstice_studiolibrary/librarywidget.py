...
from solstice_studioqt import QtGui
from solstice_studioqt import QtCore
from solstice_studioqt import QtWidgets

import solstice_studioqt

print(solstice_studioqt)
...
class LibraryWidget(QtWidgets.QWidget):
    ...
    DATABASE_PATH = "{path}/.solstice_studiolibrary/database.json"
    SETTINGS_PATH = "{local}/solstice_studiolibrary/LibraryWidget.json"
    ...
    def __init__(self, parent=None, name="", path=""):
        ...
        self.setObjectName("solstice_studiolibrary")

        solstice_studiolibrary.sendEvent("MainWindow", version=solstice_studiolibrary.version())

        resource = solstice_studiolibrary.resource()
        ...
        self._itemsWidget = solstice_studioqt.CombinedWidget(self)

        tip = "Search all current items."
        self._searchWidget = solstice_studioqt.SearchWidget(self)
        self._searchWidget.setToolTip(tip)
        self._searchWidget.setStatusTip(tip)

        self._statusWidget = solstice_studioqt.StatusWidget(self)
        self._menuBarWidget = solstice_studioqt.MenuBarWidget()
        self._foldersWidget = solstice_studioqt.TreeWidget(self)
        ...
        name = "New Item"
        icon = solstice_studioqt.resource.icon("add")
        ...
        name = "Settings"
        icon = solstice_studioqt.resource.icon("settings")
        tip = "Settings menu"
    ...
    def _itemMoved(self, item):
        ...
        :type item: solstice_studiolibrary.LibraryItem
        :rtype: None
        """
    ...
    def statusWidget(self):
        ...
        :rtype: solstice_studioqt.StatusWidget
        """
    ...
    def searchWidget(self):
        ...
        :rtype: solstice_studioqt.SearchWidget
        """
    ...
    def setPath(self, path):
        ...
        :rtype: None
        """
        path = solstice_studiolibrary.realPath(path)
        ...
        databasePath = solstice_studiolibrary.formatPath(self.DATABASE_PATH, path=path)
        database = solstice_studiolibrary.Database(databasePath)

        self.setDatabase(database)

        self.refresh()

    @solstice_studioqt.showArrowCursor
    def showPathErrorDialog(self):
        ...
        dialog = solstice_studioqt.createMessageBox(self, title, text)
    ...
    def showWelcomeDialog(self):
        ...
        title = "Welcome"
        title = title.format(solstice_studiolibrary.version(), name)
    ...
    def _showChangePathDialog(self):
        ...
        path = solstice_studiolibrary.normPath(path)
        return path
    ...
    def foldersWidget(self):
        ...
        :rtype: solstice_studioqt.TreeWidget
        """
    ...
    @solstice_studioqt.showWaitCursor
    ...
    def updateFolders(self):
        ...
        for item in solstice_studiolibrary.findItems(rootPath):
            ...
            if self.isValidInFolderView(item):
                ...
                if trashPath == path:
                    iconPath = solstice_studioqt.resource.get("icons", "delete.png")
                    paths[path] = {
                        "iconPath": iconPath
                    }
    ...
    def createFolderContextMenu(self):
        ...
        if path:
            item = solstice_studiolibrary.itemFromPath(path, libraryWidget=self)
    ...
    def itemsWidget(self):
        ...
        :rtype: solstice_studioqt.CombinedWidget
        """
    ...
    def selectItems(self, items):
        ...
        :type items: list[solstice_studiolibrary.LibraryItem]
        :rtype: None
        """
    ...
    def selectedItems(self):
        ...
        :rtype: list[solstice_studiolibrary.LibraryItem]
        """
    ...
    def updateItems(self):
        ...
        items = list(solstice_studiolibrary.findItemsInFolders(
            paths,
            depth,
            libraryWidget=self,
            )
    ...
    def createItemsFromUrls(self, urls):
        ...
        :rtype: list[solstice_studiolibrary.LibraryItem]
        """
        return solstice_studiolibrary.itemsFromUrls(urls, libraryWidget=self)
    ...
    def createNewItemMenu(self):
        ...
        icon = solstice_studiolibrary.resource().icon("add", color=color)
        ...
        for cls in sorted(solstice_studiolibrary.registeredItems(), key=_key):
            action = cls.createAction(menu, self)

            if action:
                icon = solstice_studioqt.Icon(action.icon())
    ...
    def createSettingsMenu(self):
        ...
        :rtype: solstice_studioqt.Menu
        """
        menu = solstice_studioqt.Menu("", self)
        ...
        if self.DPI_ENABLED:
            action = solstice_studioqt.SliderAction("Dpi", menu)
            dpi = self.dpi() * 100.0
        ...
        menu.addSeparator()
        theme = self.theme()
        themesMenu = solstice_studioqt.ThemesMenu(menu, theme)
    ...
    def createItemContextMenu(self, items):
        ...
        :type items: list[solstice_studiolibrary.LibraryItem]
        :rtype: solstice_studiolibrary.ContextMenu
        """
        menu = solstice_studioqt.Menu(self)
        ...
        if not self.isLocked():
            ...
            if item:
                editMenu = solstice_studioqt.Menu(menu)
    ...
    def database(self):
        ...
        :rtype: solstice_studiolibrary.Database
        """
    ...
    def setDatabase(self, database):
        ...
        :type database: solstice_studiolibrary.Database
        :rtype: None
        """
    ...
    def createMoveItemsDialog(self):
        ...
        :rtype: solstice_studioqt.MessageBox
        """
        text = 'Would you like to copy or move the selected item/s?'

        dialog = solstice_studioqt.createMessageBox(self, "Move or Copy items?", text)
    ...
    def moveItems(self, items, dst, copy=False, force=False):
        ...
        try:
            for item in items:
                ...
                if force:
                    path = solstice_studiolibrary.generateUniquePath(path)
    ...
    def settingsPath(self):
        ...
        :rtype: str
        """
        return solstice_studiolibrary.formatPath(self.SETTINGS_PATH)
    ...
    def setSettings(self, settings):
        ...
        settings = solstice_studiolibrary.update(defaults, settings)
    ...
    def saveSettings(self, settings=None):
        ...
        data = solstice_studiolibrary.readJson(path)
        data[key] = settings

        logger.debug("Saving settings {path}".format(path=path))
        solstice_studiolibrary.saveJson(path, data)
    ...
    def event(self, event):
        ...
        if isinstance(event, QtGui.QKeyEvent):
            if solstice_studioqt.isControlModifier() and event.key() == QtCore.Qt.Key_F:
    ...
    def setTheme(self, theme):
        ...
        :type theme: solstice_studioqt.Theme
        :rtype: None
        """
        self._theme = theme
    ...
    def theme(self):
        ...
        :rtype: solstice_studioqt.Theme
        """
        if not self._theme:
            self._theme = solstice_studioqt.Theme()
    ...
    def reloadStyleSheet(self):
        ...
        color = solstice_studioqt.Color.fromString(options["ITEM_TEXT_COLOR"])
        self.itemsWidget().setTextColor(color)

        color = solstice_studioqt.Color.fromString(options["ITEM_TEXT_SELECTED_COLOR"])
        self.itemsWidget().setTextSelectedColor(color)

        color = solstice_studioqt.Color.fromString(options["ITEM_BACKGROUND_COLOR"])
        self.itemsWidget().setBackgroundColor(color)

        color = solstice_studioqt.Color.fromString(
    ...
    def moveItemsToTrash(self, items):
        ...
        :items items: list[solstice_studiolibrary.LibraryItem]
        :rtype: None
        """
    ...
    def showMoveItemsToTrashDialog(self, items=None):
        ...
        :type items: list[solstice_studiolibrary.LibraryItem] or None
        :rtype: None
        """
    ...
    def showInfoDialog(self, title, text):
        ...
        return solstice_studioqt.MessageBox.question(self, title, text, buttons=buttons)
    ...
    def showErrorDialog(self, title, text):
        ...
        return solstice_studioqt.MessageBox.critical(self, title, text)
    ...
    def updateWindowTitle(self):
        ...
        title += solstice_studiolibrary.version() + " - " + self.name()
    ...
    def updateCreateItemButton(self):
        ...
        if self.isLocked():
            pixmap = solstice_studioqt.resource.pixmap("lock")
            action.setEnabled(False)
            action.setIcon(pixmap)
        else:
            pixmap = solstice_studioqt.resource.pixmap("add")
    ...
    def updateLock(self):
        ...
        if solstice_studiolibrary.user() in superusers:
    ...
    def toggleView(self):
        ...
        if solstice_studioqt.isControlModifier():
            compact = False
    ...
    def updateViewButton(self):
        ...
        if not compact:
            icon = solstice_studioqt.resource.icon("view_all")
        else:
            icon = solstice_studioqt.resource.icon("view_compact")
    ...
    def help():
        ...
        """
        import webbrowser
        webbrowser.open(solstice_studiolibrary.HELP_URL)
    ...
    def setDebugMode(self, value):
        ...
        logger_ = logging.getLogger("solstice_studiolibrary")
