...
class ThemeAction(QtWidgets.QAction):
    ...
    def __init__(self, theme, *args):
        ...
        icon = solstice_studioqt.resource.icon(ThemesMenu.THEME_ICON, color=color)
        self.setIcon(icon)
...
class ThemesMenu(QtWidgets.QMenu):
    ...
    def createActions(self):
        ...
        action = solstice_studioqt.SeparatorAction("Accent", self)
        ...
        action = solstice_studioqt.SeparatorAction("Background", self)
        self.addAction(action)
...
class Theme(QtCore.QObject):
    ...
    def setSettings(self, settings):
        ...
        if color:
            color = solstice_studioqt.Color.fromString(color)
    ...
    def accentForgroundColor(self):
        ...
        :rtype: solstice_studioqt.Color 
        """
        return solstice_studioqt.Color(255, 255, 255, 255)
    ...
    def forgroundColor(self):
        ...
        """
        if self.isDark():
            return solstice_studioqt.Color(250, 250, 250, 225)
        else:
            return solstice_studioqt.Color(0, 40, 80, 180)
    ...
    def itemBackgroundColor(self):
        ...
        """
        if self.isDark():
            return solstice_studioqt.Color(255, 255, 255, 20)
        else:
            return solstice_studioqt.Color(255, 255, 255, 120)
    ...
    def itemBackgroundHoverColor(self):
        ...
        :rtype: solstice_studioqt.Color 
        """
        return solstice_studioqt.Color(255, 255, 255, 60)

    def accentColor(self):
        """
        Return the accent color for the theme.

        :rtype: solstice_studioqt.Color or None
        """
    ...
    def setAccentColor(self, color):
        ...
        :type color: solstice_studioqt.Color | QtGui.QColor
        """
        if isinstance(color, basestring):
            color = solstice_studioqt.Color.fromString(color)

        if isinstance(color, QtGui.QColor):
            color = solstice_studioqt.Color.fromColor(color)
    ...
    def options(self):
        ...
        resourceDirname = solstice_studioqt.RESOURCE_DIRNAME.replace("\\", "/")
    ...
    def styleSheet(self):
        ...
        path = solstice_studioqt.resource.get("css", "default.css")
        styleSheet = solstice_studioqt.StyleSheet.fromPath(path, options=options, dpi=self.dpi())
