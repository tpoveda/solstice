...
class SearchWidget(QtWidgets.QLineEdit):
    ...
    def __init__(self, *args):
        ...
        self._searchFilter = solstice_studioqt.SearchFilter("")

        icon = solstice_studioqt.resource.icon("search")
        self.setIcon(icon)

        self._clearButton = QtWidgets.QPushButton(self)
        self._clearButton.setCursor(QtCore.Qt.ArrowCursor)
        icon = solstice_studioqt.resource.icon("cross")
    ...
    def setSpaceOperator(self, operator):
        ...
        :type operator: solstice_studioqt.SearchFilter.Operator
        :rtype: None
        """
    ...
    def searchFilter(self):
        ...
        :rtype: solstice_studioqt.SearchFilter
        """
    ...
    def setIconColor(self, color):
        ...
        icon = solstice_studioqt.Icon(icon)
        icon.setColor(color)
        self._iconButton.setIcon(icon)
...
def showExample():
    ...
    with solstice_studioqt.app():
        searchWidget = solstice_studioqt.SearchWidget()
