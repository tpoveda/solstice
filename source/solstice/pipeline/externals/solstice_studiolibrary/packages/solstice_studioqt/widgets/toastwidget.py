...
class ToastWidget(QtWidgets.QLabel):
    ...
    Example:
        toast = solstice_studioqt.ToastWidget(parent)
    ...
    def fadeOut(self, duration=250):
        ...
        :rtype: None 
        """
        solstice_studioqt.fadeOut(self, duration=duration, onFinished=self.hide)
    ...
    def show(self):
        ...
        if not self.isVisible():
            ...
            solstice_studioqt.fadeIn(self, duration=0)
