...
class StatusWidget(QtWidgets.QFrame):
    ...
    def showInfoMessage(self, message, msecs=None):
        ...
        icon = solstice_studioqt.resource.icon("info")
    ...
    def showErrorMessage(self, message, msecs=None):
        ...
        :rtype: None 
        """
        icon = solstice_studioqt.resource.icon("error")
    ...
    def showWarningMessage(self, message, msecs=None):
        ...
        icon = solstice_studioqt.resource.icon("warning")
    ...
    def reset(self):
        ...
        self._button.hide()
        self._label.setText("")
        icon = solstice_studioqt.resource.icon("blank")
        self._button.setIcon(icon)
        self.setStyleSheet("")
        self._blocking = False
