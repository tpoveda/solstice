...
class TreeWidgetItem(QtWidgets.QTreeWidgetItem):
    ...
    def expandedIconPath(self):
        ...
        :rtype: str 
        """
        return self._expandedIconPath or solstice_studioqt.resource.get("icons", "folder_open")
    ...
    def collapsedIconPath(self):
        ...
        :rtype: str 
        """
        return self._collapsedIconPath or solstice_studioqt.resource.get("icons", "folder")
    ...
    def defaultIconColor(self):
        ...
        color = solstice_studioqt.Color.fromColor(color).toString()
    ...
    def updateIcon(self):
        ...
        pixmap = solstice_studioqt.Pixmap(path)
    ...
    def textColor(self):
        ...
        return solstice_studioqt.Color.fromColor(color)
