...
class BasePreviewWidget(QtWidgets.QWidget):
    ...
    def __init__(self, item, parent=None):
        ...
        self.setObjectName("solstice_studiolibraryMayaPreviewWidget")
    ...
    def setCaptureMenuEnabled(self, enable):
        ...
        if enable:
            ...
            menu = solstice_mutils.gui.ThumbnailCaptureMenu(iconPath, parent=parent)
    ...
    def setItem(self, item):
        ...
        ctime = item.ctime()
        if ctime:
            self.ui.created.setText(solstice_studiolibrary.timeAgo(ctime))
    ...
    def namespaces(self):
        ...
        namespaces = solstice_studiolibrary.stringToList(namespaces)
        return namespaces
    ...
    def setNamespaces(self, namespaces):
        ...
        :rtype: None
        """
        namespaces = solstice_studiolibrary.listToString(namespaces)
    ...
    def loadSettings(self):
        ...
        :rtype: None
        """
        data = solstice_studiolibrarymaya.settings()
    ...
    def updateNamespaceEdit(self):
        ...
        if self.ui.useSelectionNamespace.isChecked():
            namespaces = solstice_mutils.namespace.getFromSelection()
