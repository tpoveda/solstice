...
class MayaLibraryWidget(MayaQWidgetDockableMixin, solstice_studiolibrary.LibraryWidget):
    ...
    def setObjectName(self, name):
        ...
        solstice_studiolibrary.LibraryWidget.setObjectName(self, name)
    ...
    def window(self):
        ...
        if self.isDocked():
            ...
            return solstice_studiolibrary.LibraryWidget.window(self)
