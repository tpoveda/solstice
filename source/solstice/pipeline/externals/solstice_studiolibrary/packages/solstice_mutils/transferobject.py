...
Example:
    ...
    t = solstice_mutils.TransferObject.fromPath("/tmp/pose.json")
    t = solstice_mutils.TransferObject.fromObjects(["object1", "object2"])
...
class TransferObject(object):
    ...
    def namespaces(self):
        ...
        if self._namespaces is None:
            group = solstice_mutils.groupObjects(self.objects())
