...
class TestAttribute(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        dirname = os.path.dirname(solstice_mutils.__file__)
    ...
    def test_attribute_limit(self):
        ...
        attr = solstice_mutils.Attribute("sphere", "testLimit")
        attr.set(200)
    ...
    def test_non_keyable(self):
        ...
        attr = solstice_mutils.Attribute("sphere", "testNonKeyable")
        attr.setKeyframe(200)
    ...
    def test_anim_curve(self):
        ...
        attr = solstice_mutils.Attribute("sphere", "testFloat")
        curve = attr.animCurve()
        assert curve is None, msg + "1"

        attr = solstice_mutils.Attribute("sphere", "testConnected")
        curve = attr.animCurve()
        assert curve is None, msg + "2"

        attr = solstice_mutils.Attribute("sphere", "testAnimated")
        curve = attr.animCurve()
    ...
    def test_set_static_keyframe(self):
        ...
        attr = solstice_mutils.Attribute("sphere", "testAnimated", cache=False)
