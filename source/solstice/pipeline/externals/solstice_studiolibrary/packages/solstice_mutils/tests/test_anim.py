...
class TestAnim(test_base.TestBase):
    ...
    def save(self, bakeConnected=False):
        ...
        """
        self.open()
        anim = solstice_mutils.Animation.fromObjects(self.srcObjects)
    ...
    #     a = solstice_mutils.Animation.fromPath(srcPath)
    ...
    def test_load_replace_completely(self):
        ...
        anim = solstice_mutils.Animation.fromPath(self.dstPath)
    ...
    def test_bake_connected(self):
        ...
        anim = solstice_mutils.Animation.fromObjects(srcObjects)
        anim.save(dstPath, bakeConnected=True)

        anim = solstice_mutils.Animation.fromPath(dstPath)
    ...
    def test_load_replace(self):
        ...
        anim = solstice_mutils.Animation.fromPath(self.dstPath)
        anim.load(self.dstObjects, option=solstice_mutils.PasteOption.Replace, startFrame=5)
    ...
    def test_load_insert(self):
        ...
        anim = solstice_mutils.Animation.fromPath(self.dstPath)
        anim.load(self.dstObjects, option=solstice_mutils.PasteOption.Insert, startFrame=5)
