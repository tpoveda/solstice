...
TEST_DATA_DIR = os.path.join(os.path.dirname(solstice_mutils.__file__), "tests", "data")
...
class TestBase(unittest.TestCase):
    ...
    def dataDir(self):
        ...
        :rtype: str
        """
        return os.path.join(os.path.dirname(solstice_mutils.__file__), "tests", "data")
    ...
    def listAttr(self, srcObjects=None, dstObjects=None):
        ...
        :rtype: list[(solstice_mutils.Attribute, solstice_mutils.Attribute)]
        """
        attrs = []
        ...
        for i, srcObj in enumerate(srcObjects):
            ...
            for srcAttr in srcAttrs:
                srcAttribute = solstice_mutils.Attribute(srcObj, srcAttr)
                dstAttribute = solstice_mutils.Attribute(dstObj, srcAttr)
