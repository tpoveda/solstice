...
"""
# Example:
import solstice_mutils.tests.test_pose
reload(solstice_mutils.tests.test_pose)
solstice_mutils.tests.test_pose.run()
"""
import unittest
...
class TestPose(test_base.TestBase):
    ...
    def test_save(self):
        ...
        """
        self.open()
        pose = solstice_mutils.Pose.fromObjects(self.srcObjects)
    ...
    def test_load(self):
        ...
        """
        self.open()
        pose = solstice_mutils.Pose.fromPath(self.dstPath)
    ...
    def test_older_version(self):
        ...
        pose = solstice_mutils.Pose.fromPath(srcPath)
        print pose.objects()
    ...
    def test_non_unique_names(self):
        ...
        pose = solstice_mutils.Pose.fromObjects(srcObjects)
        pose.save(dstPath)

        pose = solstice_mutils.Pose.fromPath(dstPath)
