...
class Node(object):
    ...
    def toShortName(self):
        ...
        if len(names) == 1:
            ...
            raise solstice_mutils.MoreThanOneObjectFoundError("More than one object found %s" % str(names))
        else:
            raise solstice_mutils.NoObjectFoundError("No object found %s" % str(self.shortname()))
