...
class ModelPanelWidget(QtWidgets.QWidget):
    ...
    def setModelPanelOptions(self):
        ...
        currentModelPanel = solstice_mutils.currentModelPanel()
    ...
    def modelPanel(self):
        ...
        return solstice_mutils.gui.wrapInstance(long(ptr), QtWidgets.QWidget)

    def barLayout(self):
        name = maya.cmds.modelPanel(self._modelPanel, query=True, barLayout=True)
        ptr = mui.MQtUtil.findControl(name)
        return solstice_mutils.gui.wrapInstance(long(ptr), QtCore.QObject)
