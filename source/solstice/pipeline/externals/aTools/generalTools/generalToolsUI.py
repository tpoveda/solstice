...
from pipeline.externals.aTools.generalTools.aToolsGlobals import aToolsGlobals as G
from pipeline.externals.aTools.commonMods      import uiMod
from pipeline.externals.aTools.commonMods      import utilMod
from pipeline.externals.aTools.commonMods      import animMod
from pipeline.externals.aTools.commonMods      import commandsMod
from pipeline.externals.aTools.commonMods      import aToolsMod
from pipeline.externals.aTools                 import setup
from pipeline.externals.aTools.generalTools    import hotkeys;                     reload(hotkeys)
from pipeline.externals.aTools.generalTools    import tumbleOnObjects;             reload(tumbleOnObjects)
from pipeline.externals.aTools.animTools       import animationCrashRecovery;      reload(animationCrashRecovery)
from pipeline.externals.aTools.animTools       import framePlaybackRange;          reload(framePlaybackRange)
from pipeline.externals.aTools.animTools       import jumpToSelectedKey;           reload(jumpToSelectedKey)
...
class GeneralTools_Gui(uiMod.BaseSubUI):
    ...
    def uninstall(self, *args):
        ...
        if confirm == 'Yes':      
            ...
            from pipeline.externals.aTools.animTools.animBar import animBarUI; reload(animBarUI)
