...
from pipeline.externals.aTools.animTools.animBar.subUIs import tangents;   reload(tangents)
from pipeline.externals.aTools.animTools.animBar.subUIs.specialTools_subUIs import mirror;   reload(mirror)
