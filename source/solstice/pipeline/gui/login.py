...
class SolsticeUserPassword(QWidget, object):
    ...
    def __init__(self, parent=None):
        ...
        _user_pixmap = resource.pixmap('user', category='icons').scaled(QSize(24, 24))
        _password_pixmap = resource.pixmap('password', category='icons').scaled(QSize(24, 24))
        _login_icon = resource.icon('go')
...
class SolsticeLoginProcess(spinner.WaitSpinner, object):
    def __init__(self, parent=None):
...
class SolsticeLogin(dialog.Dialog, object):
