...
class InfoDialog(QDialog, object):
    def __init__(self):
        ...
        logo = resource.pixmap(name='solstice_logo', extension='png')
    ...
    def show(self):
        ...
        animations.fade_window(start=0, end=1, duration=2000, object=self)
        animations.slide_window(start=30, end=0, duration=1500, object=self)
