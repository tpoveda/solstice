...
class SequenceFile(QFrame, object):
    ...
    def sync(self):
        syncdialog.SolsticeSyncPath(paths=[self._root]).sync()
...
class SequenceWidget(QWidget, object):
    ...
    def custom_ui(self):
        ...
        seq_lbl = splitters.Splitter(self.name)
        icon_lbl = QLabel()
        icon_name_layout.addWidget(seq_lbl)
        icon_name_layout.addWidget(icon_lbl)

        widget_layout.addWidget(splitters.get_horizontal_separator_widget())
        ...
        open_btn.setIcon(resource.icon('shots'))
    ...
    def get_icon(self):
        ...
        if data_folder:
            ...
            return resource.pixmap(name='solstice_logo', extension='png')
...
class ShotWidget(QWidget, object):
    ...
    def custom_ui(self):
        ...
        if self._has_previs:
            ...
            previs_layout.addLayout(splitters.SplitterLayout())
        ...
        if self._has_anim:
            ...
            anim_layout.addLayout(splitters.SplitterLayout())
        ...
        if self._has_fx:
            ...
            fx_layout.addLayout(splitters.SplitterLayout())
        ...
        if self._has_lighting:
            ...
            lighting_layout.addLayout(splitters.SplitterLayout())
