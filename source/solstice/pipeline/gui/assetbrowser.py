...
from pipeline.gui import breadcrumb
from pipeline.gui import navigationwidget
from pipeline.gui import filelistwidget
...
class AssetBrowserHeader(AssetBrowserListBase, object):
    ...
    def _setup_ui(self):
        ui = resource.gui('browser_header')
        return ui
...
class AssetBrowser(QWidget, object):
    ...
    def __init__(self, title='Asset Browser', root_path=None, parent=None):
        ...
        self.breadcrumb_widget = breadcrumb.BreadcrumbWidget()

        self._items_list = filelistwidget.FileListWidget(self)
