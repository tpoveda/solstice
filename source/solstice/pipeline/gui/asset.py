...
from pipeline.utils import qtutils, pythonutils, node
from pipeline.gui import splitters, publishedinfowidget, syncdialog, buttons
from pipeline.tools.pipelinizer import publisher
...
class AssetInfo(QWidget, object):
    ...
    def __init__(self, asset, check_published_info=False, check_working_info=False, check_lock_info=False):
        ...
        self._asset_published_info = publishedinfowidget.PublishedInfoWidget(asset=asset, check_published_info=check_published_info, check_working_info=check_working_info)
