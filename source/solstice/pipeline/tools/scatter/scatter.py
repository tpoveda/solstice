...
class SolsticeScatter(window.Window, object):
    ...
    def custom_ui(self):
        ...
        asset_viewer_layout.addLayout(splitters.SplitterLayout())
        ...
        self._mash_outliner = mashutils.get_mash_outliner_tree()
        ...
        scatter_layout.addLayout(splitters.SplitterLayout())
    ...
    def get_selected_mash_network(self):
        ...
        if not item:
            return None
        return mashutils.get_mash_network(item.getName())
    ...
    def _on_asset_click(self, asset):
        ...
        if instancer_type == 'MASH_Repro':
            repro_widget = mashutils.get_repro_object_widget(instancer)
            if not repro_widget:
                return
