...
class SanityCheckValidator(dialog.Dialog, object):
    ...
    def custom_ui(self):
        ...
        self.title = splitters.Splitter(self._title.upper())
        ...
        self.splitter = splitters.SplitterLayout()
...
class TexturesValidator(SanityCheckValidator, object):
    def __init__(self, asset):
        ...
        self._check = checkgroups.TexturesSanityCheck(asset=self._asset, auto_fix=True, stop_on_error=True)
...
class ModelValidator(SanityCheckValidator, object):
    def __init__(self, asset):
        ...
        self._check = checkgroups.AssetModelPublishSanityCheck(asset=self._asset, file_type='model', auto_fix=True, stop_on_error=True)
        self._check.check_btn.setVisible(False)
        self.scroll_layout.addWidget(self._check)
...
class ShadingValidator(SanityCheckValidator, object):
    def __init__(self, asset):
        ...
        self._check = checkgroups.AssetShadingPublishSantiyCheck(asset=self._asset, file_type='shading', auto_fix=True, stop_on_error=True)
        self._check.check_btn.setVisible(False)
        self.scroll_layout.addWidget(self._check)
