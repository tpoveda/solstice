...
class SolsticePropAsset(asset.SolsticeAsset, object):

    ASSET_TYPE = defines.SOLSTICE_PROP_ASSETS
    ASSET_FILES = {
    ...
    def __init__(self, project, asset_data):
        super(SolsticePropAsset, self).__init__(project=project, asset_data=asset_data)
