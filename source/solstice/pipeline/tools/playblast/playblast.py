...
class SolsticeCameras(SolsticePlayblastWidget, object):
    ...
    def custom_ui(self):
        ...
        refresh_icon = resource.icon('refresh')
...
class PlayblastPreset(QWidget, object):
    ...
    def __init__(self, inputs_getter, parent=None):
        ...
        preset_config_icon = resource.icon('config')
        ...
        open_templates_folder_icon = resource.icon('overview')
...
class SolsticeTemplateConfiguration(dialog.Dialog, object):
...
class SolsticePlayBlast(window.Window, object):
    ...
    def custom_ui(self):
        ...
        self.main_widget = accordion.AccordionWidget(parent=self)
        self.main_widget.rollout_style = accordion.AccordionStyle.MAYA
...
def snap(*args, **kwargs):
    ...
    if clipboard:
        qtutils.image_to_clipboard(output)
