...
from solstice.pipeline.tools.changelog import changelog


class SolsticeHelloDialog(dialog.Dialog, object):

    name = 'hello'                          # Do not change or UI load'll fail and Maya'll crash painfully
    ...
    def custom_ui(self):
        ...
        logo_gif = resource.get('icons', 'solstice_logo.gif')
        ...
        self.ui.documentation_btn.clicked.connect(lambda : pythonutils.open_web('https://tpoveda.github.io/solstice/'))
    ...
    def set_index(self, index):
        animations.fade_animation(start='current', end=0, duration=400, object=self.tab_opacity_effect)
    ...
    def _on_fade_up_tab(self):
        animations.fade_animation(start='current', end=1, duration=400, object=self.tab_opacity_effect)
