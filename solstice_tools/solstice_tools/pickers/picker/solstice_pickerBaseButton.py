...
class solstice_pickerBaseButton(QPushButton, object):
    ...
    def paintInner(self, painter, x, y, width, height):
        ...
        if self._shape == solstice_pickerButtonShape.circular:
            ...
            painter.drawRoundedRect(QRect(x + self._borderSize+2, y + self._borderSize+2, width - (self._borderSize+4), height - (self._borderSize+4)), self._radius-1, self._radius-1)
