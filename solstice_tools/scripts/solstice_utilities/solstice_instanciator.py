...
class solstice_instanciator(QMainWindow, object):
    def __init__(self):
        super(solstice_instanciator, self).__init__(_getMayaWindow())

        winName = 'solstice_instanciator_window'
        ...
        self.setWindowTitle('Solstice Tools - Instanciator - v.1.0')
        self.customUI()
        self.show()
