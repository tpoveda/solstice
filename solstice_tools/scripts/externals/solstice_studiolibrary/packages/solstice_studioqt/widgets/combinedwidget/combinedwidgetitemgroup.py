...
class CombinedWidgetItemGroup(solstice_studioqt.CombinedWidgetItem):

    DEFAULT_FONT_SIZE = 24

    def __init__(self, *args):
        solstice_studioqt.CombinedWidgetItem.__init__(self, *args)
    ...
    def paintBackground(self, painter, option, index):
        ...
        :rtype: None
        """
        solstice_studioqt.CombinedWidgetItem.paintBackground(self, painter, option, index)
